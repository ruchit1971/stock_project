        ...
        try:
            ...
            if stock_price_history.size > 10:
                ...
                if yu < int('2012'):
                    ...
                    A1_5_with_inflation = stock_price_history[(stock_price_history['Date'] > str(current_month) + '-' + year_5)]
                    ...
                    # Interest with Inflation
                    r_5_with_inflation = (n * (((A_5 + ini_div66_5) / P_5_with_inflation) ** (1 / (n * t_5)) - 1)) * 100
                    ...
                    final_interest_data = np.array(
                        [[str(t + 1) + " Years", r, r_with_inflation, A1.loc[last_index].at["Num Stock"], ini_div, ini_div66],
                         [str(t_5 + 1) + ' Years', r_5, r_5_with_inflation, A1_5.loc[last_index_5].at["Num Stock"], ini_div_5,
                          ini_div66_5]])
                    ...
                    A1_with_inflation = stock_price_history[(stock_price_history['Date'] > str(current_month) + '-' + str(yu))]
                    A2 = A1[['Date', 'Close']]
                    ...
                    # Interest with Inflation
                    r_5_with_inflation = (n * (((A + ini_div66_5) / P_5_with_inflation) ** (1 / (n * t_5)) - 1)) * 100
                    r_5_with_inflation = float("{:.2f}".format(r_5_with_inflation))
                ...
                if a == 1:
                    ...
                    FilePathName = r"/Users/ruchitbhikadiya/Desktop/stock_project/Excel_Files_Stocks/" + Filename
                    writer = pd.ExcelWriter(FilePathName, engine='openpyxl', mode='a', if_sheet_exists='replace')
